...
func builtinRegistrations(router *Router) []tool.ToolRegistration {
	...
	return []tool.ToolRegistration{
		...
		registration(router, source, "data", "schema", OperationDataSchema,
			...
			[]tool.Protocol{tool.ProtocolMySQL, tool.ProtocolMariaDB, tool.ProtocolSQLServer, tool.ProtocolPostgreSQL, tool.ProtocolRedis, tool.ProtocolMongoDB}, []tool.Capability{"data.schema"}, tool.RiskReadOnly, tool.ApprovalNever,
		...
		registration(router, source, "data", "query", OperationDataQuery,
			...
			[]tool.Protocol{tool.ProtocolMySQL, tool.ProtocolMariaDB, tool.ProtocolSQLServer, tool.ProtocolPostgreSQL, tool.ProtocolRedis, tool.ProtocolMongoDB}, []tool.Capability{"data.query"}, tool.RiskHigh, tool.ApprovalByPolicy,
