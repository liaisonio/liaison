...
func builtinRegistrations(router *Router) []tool.ToolRegistration {
	...
	return []tool.ToolRegistration{
		...
		registration(router, source, "data", "schema", OperationDataSchema,
			...
			[]tool.Protocol{tool.ProtocolS3, tool.ProtocolMemcached, tool.ProtocolElasticsearch, tool.ProtocolOpenSearch, tool.ProtocolMySQL, tool.ProtocolMariaDB, tool.ProtocolDoris, tool.ProtocolStarRocks, tool.ProtocolTiDB, tool.ProtocolSQLServer, tool.ProtocolOracle, tool.ProtocolDameng, tool.ProtocolClickHouse, tool.ProtocolPostgreSQL, tool.ProtocolRedis, tool.ProtocolMongoDB}, []tool.Capability{"data.schema"}, tool.RiskReadOnly, tool.ApprovalNever,
		...
		registration(router, source, "data", "query", OperationDataQuery,
			...
			[]tool.Protocol{tool.ProtocolMemcached, tool.ProtocolElasticsearch, tool.ProtocolOpenSearch, tool.ProtocolMySQL, tool.ProtocolMariaDB, tool.ProtocolDoris, tool.ProtocolStarRocks, tool.ProtocolTiDB, tool.ProtocolSQLServer, tool.ProtocolOracle, tool.ProtocolDameng, tool.ProtocolClickHouse, tool.ProtocolPostgreSQL, tool.ProtocolRedis, tool.ProtocolMongoDB}, []tool.Capability{"data.query"}, tool.RiskHigh, tool.ApprovalByPolicy,
