...
func (g *ModelGenerator) Suggest(ctx context.Context, binding Binding, input Input) (string, error) {
	...
	request := runtime.ModelRequest{Selection: input.ModelSelection, SessionID: input.AgentSessionID, Messages: append(append([]runtime.ModelMessage{}, input.AgentContext...), []runtime.ModelMessage{
