...
type AccessKey struct {
	...
	WindowsCommand string                 `protobuf:"bytes,4,opt,name=windows_command,proto3" json:"windows_command,omitempty"` // Windows PowerShell 安装命令
...
func (x *AccessKey) GetWindowsCommand() string {
	if x != nil {
		return x.WindowsCommand
	}
	return ""
}
...
func (x *CreateProxyRequest) GetAccessProtocol() string {
	if x != nil {
		return x.AccessProtocol
	}
	return ""
...
const file_liaison_proto_rawDesc = "" +
	...
	"\x05edges\x18\x02 \x03(\v2\x05.EdgeR\x05edges\"\x8f\x01\n" +
	"\tAccessKey\x12\x1e\n" +
	"\n" +
	...
	"secret_key\x12(\n" +
	"\x0fwindows_command\x18\x04 \x01(\tR\x0fwindows_command\x12\x18\n" +
