...
const ConnectorPage: React.FC = () => {
  ...
  const createScannedAccess = async (event: FormEvent) => {
    ...
    try {
      ...
      setNotice({ tone: 'success', text: tr('应用和访问已创建', 'Application and access created') });
