...
const WEB_ACCESS_TYPES: ReadonlyArray<AccessTypeOption> = [
  ...
  { value: 'websftp', label: 'WebSFTP' },
  { value: 'webrdp', label: 'WebRDP' },
  { value: 'webvnc', label: 'WebVNC' },
  { value: 'webmysql', label: 'WebMySQL' },
  { value: 'webmariadb', label: 'WebMariaDB' },
  { value: 'webdoris', label: 'WebDoris' },
  { value: 'webstarrocks', label: 'WebStarRocks' },
  { value: 'webtidb', label: 'WebTiDB' },
  { value: 'websqlserver', label: 'WebSQL Server' },
  { value: 'weboracle', label: 'WebOracle' },
  { value: 'webdameng', label: 'WebDameng' },
  { value: 'webclickhouse', label: 'WebClickHouse' },
  { value: 'webelasticsearch', label: 'WebElasticsearch' },
  { value: 'webopensearch', label: 'WebOpenSearch' },
  { value: 'webpostgresql', label: 'WebPostgreSQL' },
  { value: 'webredis', label: 'WebRedis' },
  { value: 'webmemcached', label: 'WebMemcached' },
  { value: 'webs3', label: 'WebS3' },
  { value: 'websmb', label: 'WebSMB' },
  { value: 'webmongodb', label: 'WebMongoDB' },
